...
const Information = () => {
    ...
    <div className="m-10 mx-auto px-16 sm:px-24 sm:py-12 lg:px-48 bg-gray-200">
      ...
      <div className="relative rounded-lg block md:flex items-center bg-gray-100 shadow-xl" style={{minHeight: "19rem"}}>
        <div className="relative w-full md:w-2/5 h-full overflow-hidden rounded-t-lg md:rounded-t-none md:rounded-l-lg" style={{minHeight: "19rem"}}>
          ...
          <div className="absolute inset-0 w-full h-full bg-orange-500 opacity-75"></div>
          ...
          <h2 className="font-bold text-2xl">News & Updates</h2>
          </div>
        </div>
        <div className="w-full md:w-3/5 h-full flex items-center bg-gray-100 rounded-lg">
          
          <div className="p-12 md:pr-24 md:pl-16 md:py-12">
          <h3 className="font-bold text-center">Global Energy Show: Aduda advocates collaboration among Industry Stakeholders</h3>
            <br />
            <p className="text-gray-600">The <span className="text-orange-500">Permanent Secretary, {" "}</span>
            Ministry of Petroleum Resources, Amb. Gabriel Tanimu Aduda has
             urged global Oil and Gas stakeholders to embrace collaboration in the 
            quest to emplace energy safety, affordability, security and sustainability across the value chain.</p>
            <a className="flex items-baseline mt-3 text-green-600 hover:text-orange-900 focus:text-orange-900" href="">
